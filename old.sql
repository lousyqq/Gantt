...
/* =====================================================================
   補充基準段(已於遠端主機在 01~05 之後執行過):
   補齊 2026 第 53 週 + 建立 2027 年度週資料(皆為冪等,可重複執行)
===================================================================== */
GO
/* 2026 W53:ISO 週 53(2026-12-28 ~ 2027-01-03),所屬月份取該週週四(2026-12-31) → 2026/12 */
IF NOT EXISTS (SELECT 1 FROM dbo.ScheduleWeeks WHERE ScheduleYear = 2026 AND WeekNo = 53)
    INSERT dbo.ScheduleWeeks(ScheduleYear, WeekNo, MonthName, MonthLabel) VALUES(2026, 53, '202612', N'2026/12');
GO
/* 2027 年度(52 週):usp_EnsureScheduleYear 本身冪等,已存在即跳過 */
